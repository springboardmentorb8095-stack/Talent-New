...
// import api from "../services/api"; // <-- keep your existing api.js

// const ReviewForm = ({ contractId, onReviewSubmitted }) => {
...
//     api.post(`reviews/add/${contractId}/`, { rating, comment })
//       .then((res) => {
...
//           <Typography sx={{ color: "#EAF6F7" }}>Rating:</Typography>
//           <Rating
...
//             "& .MuiInputLabel-root.Mui-focused": { color: "#5E9FA6" },
//           }}
//         />
