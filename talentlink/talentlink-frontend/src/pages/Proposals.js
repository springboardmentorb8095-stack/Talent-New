...
// // //               api
// // //                 .get(
// // //                   `http://127.0.0.1:8000/api/proposals/projects/${project.id}/proposals/`
// // //                 )
// // //                 .then((pRes) => {
// // //                   proposalMap[project.title] = pRes.data.results || [];
// // //                 })
// // //             )
// // //           ).then(() => {
// // //             setClientProposals(proposalMap);
// // //             setLoading(false);
// // //           });
// // //         })
...
// // //     api
// // //       .patch(`http://127.0.0.1:8000/api/proposals/${id}/status/`, { status })
// // //       .then(() => {
...
// // //         <Divider sx={{ bgcolor: "rgba(94,159,166,0.3)", mb: 5 }} />

// // //         {loading ? (
// // //           <Typography align="center">Loading proposals...</Typography>
// // //         ) : isClient ? (
// // //           /* ================= CLIENT VIEW ================= */
// // //           Object.keys(clientProposals).length === 0 ? (
// // //             <Typography>No proposals received yet.</Typography>
// // //           ) : (
// // //             Object.entries(clientProposals).map(([project, proposals]) => (
// // //               <Box key={project} sx={{ mb: 6 }}>
// // //                 <Typography variant="h5" sx={{ color: "#5E9FA6", mb: 2 }}>
// // //                   {project}
// // //                 </Typography>
...
// //                 )
// //                 .then((pRes) => {
// //                   map[project.title] = pRes.data.results || [];
// //                 })
// //             )
// //           );
...
// //             updated[project] = updated[project].map((p) =>
// //               p.id === id ? { ...p, status } : p
// //             );
// //           });
// //           return updated;
...
// //         <Typography sx={{ color: "#A0C4C9", mb: 4 }}>
// //           {isClient
// //             ? "Manage proposals received from freelancers"
// //             : "Track and monitor all your submitted proposals"}
// //         </Typography>
...
// //           ) : (
// //             Object.entries(clientProposals).map(([project, proposals]) => {
// //               const filtered = filterByStatus(proposals);
// //               if (filtered.length === 0) return null;

// //               return (
// //                 <Box key={project} sx={{ mb: 6 }}>
// //                   <Typography variant="h5" sx={{ color: "#5E9FA6", mb: 3 }}>
// //                     {project}
// //                   </Typography>
...
// //           /* ================= FREELANCER VIEW ================= */
// //           <Grid container spacing={4}>
// //             {filterByStatus(freelancerProposals).map((p) => (
// //               <Grid item xs={12} md={6} lg={4} key={p.id}>
// //                 <Fade in>
// //                   <Card
// //                     sx={{
...
//   Avatar,
// } from "@mui/material";
// import { CheckCircle, Cancel, AccessTime, MonetizationOn, Logout } from "@mui/icons-material";
...
//                     >
//                       <CardContent>
//                         <Typography variant="h6">{p.project_title}</Typography>
